...
**Last updated:** 2026-07-28 | **Total patterns:** 92 | **Resolved:** 21 | **Active:** 71
...
- **Git `--` flag ordering** — 6 instances, 6 agents → [build.md](build.md) (rule + warn-only hook exist; git rejects regardless, so recurrences self-correct at zero cost — NOT a #82 escalation, git IS the enforcement; +ServerAPI t/1788 p/79#13, +CL.Investigate1 t/1767 p/40#11)
