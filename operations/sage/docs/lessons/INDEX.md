...
**Last updated:** 2026-06-25 | **Total patterns:** 38 | **Resolved:** 10 | **Active:** 28

## Summary

| Category | File | Patterns | Resolved | Active |
|----------|------|----------|----------|--------|
| Build | [build.md](build.md) | 20 | 5 | 15 |
...
- **Push contention (multi-agent)** — 2 instances → [build.md](build.md)
