...
- 2026-08-10 — DevOps (t/2428, PR #791, p/26#75): `.Trim()` on null `az` CLI result under StrictMode — "Cannot call a method on a null-valued expression." Fix: null-coerce before calling (`$result?.Trim()` or explicit `$null` guard).
