...
<!-- STRUCTURAL NOTE: The 23 subsections below fall into six thematic groups, but the
current ordering does not permit clean grouping headers without moving sections.
A future reordering pass should arrange them as follows:

  6A. Debate Protocol and Turn Architecture (6.1-6.3)
  6B. Argumentation Quality and Move Diversity (6.4-6.8)
  6C. Safety, Robustness, and Failure Mode Interventions (6.9-6.11)
  6D. Convergence Diagnostics and Phase Management (6.12, 6.23)
  6E. Post-Debate Analysis and Taxonomy Evolution (6.13-6.14, 6.20-6.21)
  6F. Context Management and Specialized Features (6.15-6.19, 6.22)

Groups 6D, 6E, and 6F are currently interleaved; reordering requires moving
6.23 adjacent to 6.12, 6.20-6.21 adjacent to 6.13-6.14, and 6.22 adjacent
to 6.15-6.19, with corresponding cross-reference updates. -->
