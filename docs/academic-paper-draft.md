...
The system is deployed and actively used for AI policy research, operating on 173 source documents, 565 taxonomy nodes with validated graph attributes (11 metadata fields per node, 0 errors after quality pass), ~1,500 conflict instances, and 100+ structured debate sessions.
