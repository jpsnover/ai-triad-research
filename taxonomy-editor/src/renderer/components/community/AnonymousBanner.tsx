...
export function AnonymousBanner() {
  ...
  return (
    <div className="anonymous-banner">
      ...
      <a href="/.auth/login/github" className="anonymous-banner-link">Sign in with GitHub</a>
      <a href="/.auth/login/google" className="anonymous-banner-link anonymous-banner-link-alt">Sign in with Google</a>
    </div>
  );
}
