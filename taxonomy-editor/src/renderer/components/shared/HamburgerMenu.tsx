    ...
    <>
      ...
      {auth.anonymous ? (
        <>
          ...
          <a className="hamburger-item" href="/api/auth/fresh-login/google" style={{ textDecoration: 'none', color: 'inherit' }}>
...
export function HamburgerMenu({ isOpen, onClose }: HamburgerMenuProps) {
  ...
  const switchTab = useCallback((tab: 'situations' | 'conflicts' | 'cruxes' | 'debate' | 'chat' | 'summaries' | 'validation' | 'organizations') => {
    clearCurrentPanel();
  ...
  const browseItems: MenuItem[] = [
    ...
    },
    {
      ...
      active: activeTab === 'organizations' && toolbarPanel === null,
      action: () => switchTab('organizations'),
    },
  ];
