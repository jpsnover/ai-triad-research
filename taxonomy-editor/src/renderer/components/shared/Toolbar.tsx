        ...
        <div className="toolbar-auth-popover" role="menu">
          {auth.anonymous ? (
            <>
              ...
              <a className="toolbar-more-item" href="/.auth/login/google" style={{ textDecoration: 'none', color: 'inherit' }}
                onClick={() => setShowPopover(false)}>
  ...
  return (
    <div className="toolbar">
      <div className="toolbar-top">
        ...
        {/* Validation */}
        <button
          className={`toolbar-icon${activeTab === 'validation' && toolbarPanel === null ? ' toolbar-icon-active' : ''}`}
