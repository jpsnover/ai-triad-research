...
import { isAuthDisabledAllowed, isPathWithinDir, isTerminalAccessAllowed, isAnonAllowedRoute, invalidRouteParam, callerTierIdentity, missingApiKeyError, expiredAuthCookies, anonymousSessionCookies, hasEasyAuthSessionCookie, resolveTestPersonaOverride } from './security/accessControl.js';
 ...
 * t/1687: the /api/ai/* run moved to routes/ai.ts (which mirrors this pure helper);
 * this copy stays for the calibration run below that also calls callerIdentity().
 */
