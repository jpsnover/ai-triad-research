...
**Status of the underlying proposal:** pending internal owner and technical-lead approval; nothing described here has been implemented yet. Two independent external reviews of this document (2026-07-13) are addressed in `corroboration-design.md`'s changelog and in ticket t/1523; the amendments (exclusion-mechanism guardrails, validation-study scope, rollout resequencing) are reflected inline below. A terminology rename away from "Corroboration" and an investigation into a complementary "crux-discovery-density" signal, both raised by the reviews, remain open and are tracked as separate tickets (t/1533, t/1534).
