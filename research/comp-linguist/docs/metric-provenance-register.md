...
|---|---|---|---|
| Testing-deficit ladder (1.0/0.7/0.6/0.4/0.1) | `corroboration-design.md` | stipulated | Severe-test scheduler input (Phase 3, not yet implemented). |
| Node importance weights (0.35/0.25/0.20/0.20) | `corroboration-design.md` | stipulated | Severe-test scheduler input (Phase 3). t/1534 recommends reweighting to 0.25 degree / 0.15 crux-density / 0.25 policy / 0.20 doctrinal / 0.15 usage when Phase 3 is cut. |
...
Rows for the Debate-Tested tier instrument moved to §1 on 2026-07-15 (Phase 0 implemented, t/1545 `7f4b85f8`; renamed per t/1533).
